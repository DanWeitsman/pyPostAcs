...
dir = '/Users/danielweitsman/Box/Jan21Test/TAMU/runs/cshb'
...
f2 = lambda a,b: fun.tseries((a['Acoustic Data (mV)'][:].transpose()/(a['Sensitivities'][:]*1e-3)), fs =  40e3,t_lim = [0,10], levels = [-0.25,0.25], save_path = b,save_fig=True)
