...
dir ='/Users/danielweitsman/Box/Jan21Test/TAMU/runs/rpm_sweeps/cghb'
...
#todo interpolate the rpm that corresponds to the sum of the thrust and torque of the upper and lower rotor. Fix uncertainties.
ax.errorbar(rpm_avg_2, T_avg_2+T_avg_1, yerr=T_err_2, fmt='o')

ax.set_ylabel('Thrust, T (N)')
ax.set_xlabel('RPM')
# ax.set_xlim([975,5000])
# ax.set_ylim([0,40])
...
ax.errorbar(rpm_avg_2, Q_avg_2+Q_avg_1, yerr=Q_err_2, fmt='o')
